...
describe("SubmitPage", () => {
  beforeEach(() => {
    ...
    getEntrySubmissionGateMock.mockResolvedValue({
      ...
      remaining_posts: 1,
      unlimited: false,
      next_score_required: 9,
      next_review_actions_required: 9,
      actions_required_for_unlimited: 12,
      score_required_for_unlimited: 12,
      ...
      step2_posts: 2,
      step3_actions: 12,
      active_participation_label: null,
      votes_today: 3,
      unlocked_posts: 2,
      next_votes_required: 9,
      votes_required_for_unlimited: 12,
    });

...
class Settings(BaseSettings):
    ...
    entry_participation_window_days: int = 7
    ...
    entry_participation_step1_actions: int = 0
    entry_participation_step1_posts: int = 1
    entry_participation_step2_actions: int = 3
    entry_participation_step2_posts: int = 2
    entry_participation_step3_actions: int = 12
    entry_participation_step3_unlimited: bool = False
    entry_participation_unlimited_daily_cap: int | None = 20
    entry_participation_exempt_staff: bool = False
    entry_participation_entry_vote_weight: float = 1.0
    entry_participation_example_vote_weight: float = 1.0
    entry_participation_comment_vote_weight: float = 0.0
    entry_participation_page_excellent_weight: float = 0.0
    entry_participation_page_fair_weight: float = 0.0
    entry_participation_page_poor_weight: float = 0.0

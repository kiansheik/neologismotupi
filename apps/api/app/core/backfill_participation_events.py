"""Backfill review_participation_events from existing entry and example votes.

Usage from apps/api:
    uv run python -m app.core.backfill_participation_events [--window-days 7] [--apply]

Without --apply the command runs in dry-run mode and prints what it would insert.
